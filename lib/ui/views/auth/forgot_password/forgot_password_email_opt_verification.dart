...
class ForgotPasswordEmailOtpVerification extends StatefulWidget {
  const ForgotPasswordEmailOtpVerification({Key? key}) : super(key: key);

  @override
  State<ForgotPasswordEmailOtpVerification> createState() =>
      _ForgotPasswordEmailOtpVerificationState();
}

class _ForgotPasswordEmailOtpVerificationState
    extends State<ForgotPasswordEmailOtpVerification> {
  ...
  void verifyCode(String email, String code) async {
    ...
    try {
      ...
      await authController.verifyForgotPasswordOTP(email, code);
      EasyLoading.dismiss();
      ...
      await EasyLoading.showSuccess(
        ...
        EasyLoading.dismiss();
        Get.toNamed("/set_new_password", arguments: {'email': email});
      });
    } on Error catch (e) {
      EasyLoading.dismiss();
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            Center(
              child: Text(
                "To confirm your account, enter the code that was sent to $email.",
            ...
            Padding(
              ...
              child: PinCodeTextField(
                ...
                onChanged: (value) {},
                onCompleted: (value) {
                  // verifyCode(Get.arguments['email']?? "", value);
                },
                showCursor: false,
